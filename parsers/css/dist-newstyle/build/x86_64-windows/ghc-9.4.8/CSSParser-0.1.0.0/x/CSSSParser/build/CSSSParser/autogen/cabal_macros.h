...
/* package CSSParser-0.1.0.0 */
#ifndef VERSION_CSSParser
#define VERSION_CSSParser "0.1.0.0"
#endif /* VERSION_CSSParser */
#ifndef MIN_VERSION_CSSParser
#define MIN_VERSION_CSSParser(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_CSSParser */
...
#define CURRENT_COMPONENT_ID "CSSParser-0.1.0.0-inplace-CSSSParser"
