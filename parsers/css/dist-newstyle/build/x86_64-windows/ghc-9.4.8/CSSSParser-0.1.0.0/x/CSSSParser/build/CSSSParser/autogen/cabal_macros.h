...
/* package CSSSParser-0.1.0.0 */
#ifndef VERSION_CSSSParser
#define VERSION_CSSSParser "0.1.0.0"
#endif /* VERSION_CSSSParser */
#ifndef MIN_VERSION_CSSSParser
#define MIN_VERSION_CSSSParser(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_CSSSParser */
...
#define CURRENT_COMPONENT_ID "CSSSParser-0.1.0.0-inplace-CSSSParser"
